        ...
        <div
          className={`rounded-2xl px-4 py-2.5 text-sm leading-relaxed whitespace-pre-wrap break-words ${
            isUser
              ...
              : "bg-surface border border-gray-200 text-gray-800 rounded-tl-sm shadow-sm"
          }`}
        >
...
export default function ChatPage() {
  ...
  return (
    <div className="flex flex-col h-full">
      {/* Header */}
      <div className="border-b border-gray-200 bg-surface px-6 py-4 flex items-center gap-3 flex-shrink-0">
      ...
      {/* Input */}
      <div className="border-t border-gray-200 bg-surface px-4 sm:px-6 py-4 flex-shrink-0">
